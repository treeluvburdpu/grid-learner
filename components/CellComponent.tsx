...
export const SquareCellComponent: React.FC<SquareCellProps> = React.memo(({
    ...
    return (
        <div
            className={`grid-cell-base ${baseSizeClasses || 'aspect-square'} ${textStyleClass} ${bgClass} ${borderClasses} ${interactiveClasses} ${className || ''} ${opacityClass}`}
            style={finalStyle}
            onClick={onClick}
